...
const WhatsApp = () => {
  ...
  const accountSid = "AC830f9bc269a290de3a6cae63df414d7a";
      ...
      <div className="whatsapp-card app">
        ...
        <div className="message app" style={{ marginTop: "1.5em" }}>
          <CssTextField
            ...
            helperText={
              !(message.length > CHARACTER_LIMIT - 1) ? `${message.length}/${CHARACTER_LIMIT}` : "Max length exceeded"
            }
          />
        </div>
